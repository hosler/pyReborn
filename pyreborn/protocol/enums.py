...
class PlayerProp(IntEnum):
    ...
    PLPROP_GATTRIB5 = 41
    PLPROP_ATTACHNPC = 42
    # GMAPLEVELX is already at 43
    # GMAPLEVELY is already at 44
    # Z is at 45 below
    
    # Extended properties
    PLPROP_Z = 45  # Z coordinate (old style)
    # GATTRIB 6-30 start at property 46
    ...
    PLPROP_GMAPLEVELX = 43  # GMAP X segment position
    PLPROP_GMAPLEVELY = 44  # GMAP Y segment position
    PLPROP_GATTRIB6 = 46
    PLPROP_GATTRIB7 = 47
    PLPROP_GATTRIB8 = 48
    PLPROP_GATTRIB9 = 49
    ...
    # Unknown/custom properties seen in the wild
    PLPROP_UNKNOWN84 = 84
    PLPROP_UNKNOWN85 = 85
    PLPROP_UNKNOWN87 = 87
    PLPROP_UNKNOWN96 = 96
    PLPROP_UNKNOWN109 = 109
    PLPROP_UNKNOWN112 = 112
    PLPROP_UNKNOWN115 = 115
    PLPROP_UNKNOWN120 = 120
    PLPROP_UNKNOWN121 = 121
    PLPROP_UNKNOWN122 = 122
    PLPROP_UNKNOWN123 = 123
    PLPROP_UNKNOWN124 = 124
    PLPROP_UNKNOWN125 = 125
    PLPROP_UNKNOWN126 = 126
    PLPROP_UNKNOWN127 = 127
